<template>
    <div>
      <el-tabs type="card" style="margin-left: 5px">
        ...
        <el-tab-pane label="年" key="6">
          <div>
            <el-radio-group v-model="result.year.cronEvery">
              ...
              <el-row>
                <el-radio label="4" value="4">从
                  <el-input-number size="small" v-model="result.year.rangeStart" :min="2020" :max="2120"></el-input-number>
                  到
                  <el-input-number size="small" v-model="result.year.rangeEnd" :min="2020" :max="2120"></el-input-number>
                  年之间的每一年
                </el-radio>
              </el-row>
            </el-radio-group>
