...
export default {
    numberFilterOptions: numberFilterOptions,
    dateFilterOptions: dateFilterOptions,
    textFilterOptions: textFilterOptions,
    iconList: iconList,
    dirArr: dirArr,
    xAxisOptions: xAxisOptions,
    xAxisDataOptions: xAxisDataOptions,
    yAxisOptions: yAxisOptions,
    yAxisNumOptions: yAxisNumOptions,
    filterOptions: filterOptions,
    metricsIconList: metricsIconList,
    axisList: axisList,
    doubleLineAxisList: doubleLineAxisList,
    axisNumOptions: axisNumOptions,
    axisDateOptions: axisDateOptions,
    pivotList: pivotList,
