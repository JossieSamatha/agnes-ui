<template>
  <div class="roster-container">
    <div class="roster-item" v-for="(roster, index) in rosterList" :key="index">
      <div class="icon">
        <img src="../../../assets/clientView/avatar.png" alt="avatar" width="40px" height="40px"
      ...
      <div class="info">
        ...
        <p>
          ...
          <span>{{
              pageType === 'personal' ? roster.rosterDate : roster.oTel && roster.oTel.substr(0, 4)
            }}</span>
  ...
  methods: {
    initDate() {
      this.$api.changeDataApi.getChangeData().then((resp) => {
        ...
        this.$api.HomePageApi.selectRosterDetailOfWeekOld({
          rosterDate: exeTime,
