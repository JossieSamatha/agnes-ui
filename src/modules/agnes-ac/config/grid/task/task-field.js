...
export default {
    columnDefs: [
        ...
        {headerName: "业务场景", field: "bizType", dictType: 'AC_BIZ_TYPE'},
        {headerName: "产生方式", field: "genMode", dictType: 'AC_GEN_MODE'},
        {headerName: "关联产品", field: "caseId"},
        {headerName: "任务截至时间", field: "endTime"},
        {headerName: "完成状态", field: "taskStatus",dictType:'AC_TASK_STATUS'},
        column.colCrtUser,
        column.colCrtTm,
