    ...
    <div class="form-page">
        ...
        <el-form ref="stepInfoForm"  class="task-def-form" :rules="caseStepRules"
            ...
            <el-form-item v-if="activeTerm === '2'">
                <rule-table ref="activeRuleTable" :ruleTableData="stepInfo.stepFormInfo.activeRuleTableData"
            ...
            <el-form-item v-if="succeedRule === '1'">
                <rule-table ref="successRuleTable" :ruleTableData="stepInfo.stepFormInfo.successRuleTableData"
                            :ruleTargetOp="ruleTargetOp"></rule-table>
            </el-form-item>
            ...
            <el-form-item v-if="abnormalRule === '1'">
                <rule-table ref="failRuleTable" :ruleTableData="stepInfo.stepFormInfo.failRuleTableData"></rule-table>
            </el-form-item>
        </el-form>
    </div>
</template>
