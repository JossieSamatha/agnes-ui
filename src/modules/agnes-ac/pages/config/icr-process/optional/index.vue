      ...
      <div class="bottom left" id="taskContainerLeft">
        ...
        <div v-show="ifGridExpand" class="drag-column">
          <gf-grid ref="elecGrid" class="elec-grid"
                   ...
                   height="100%"
                   grid-no="agnes-icr-process-field"
  ...
  export default {
    ...
    methods: {
      ...
      async getFLowDetail(taskExecId, bizDate, ifLoading) {
        ...
        try {
          const flowDetailStr = await this.$api.icrProcessApi.getIcrProcessBrief({taskExecId, bizDate});
      ...
      showIndexDetail(params) {
        ...
        this.$drawerPage.create({
          className: 'icr-dashboard-drawer',
