    ...
    export default {
        ...
        methods: {
            async save() {
                if (this.mode == 'check') {
                    try {
                        const p = this.$api.ServiceConfApi.changeServiceStatus({
                            serviceResponseId: this.form.serviceResponseId,
                            status: '02'
                        });
                    ...
                    try {
                        const p = this.$api.ServiceConfApi.saveService({
                            reServiceResponse: this.form,
