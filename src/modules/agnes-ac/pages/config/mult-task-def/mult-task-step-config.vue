      ...
      <module-card title="执行规则" shadow="never">
        <template slot="content">
          ...
          <el-form-item v-if="succeedRule === '1'">
            <rule-table :isDisable="optionType=='view'" ref="successRuleTable" confType="fn,event" :ruleTableData="stepInfo.stepFormInfo.successRuleTableData"
                        :ruleTargetOp="ruleTargetOp"></rule-table>
          </el-form-item>
          ...
          <el-form-item v-if="abnormalRule === '1'">
            <rule-table :isDisable="optionType=='view'" ref="failRuleTable" confType="fn,event" :ruleTableData="stepInfo.stepFormInfo.failRuleTableData"
                        :ruleTargetOp="ruleTargetOp"></rule-table>
          </el-form-item>
              ...
              <el-tab-pane v-for="(msgInformItem, msgInformIndex) in msgInformParam" :key="msgInformIndex"
                ...
                <el-form size="small" label-width="100px" v-show="msgInformItem === '2'">
                  ...
                  <el-form-item label-width="113px"  label="服务水平承诺">
                    ...
                    <gf-input :value= "repeatMinutes" style="width: 15%" :disabled="true"></gf-input>分钟，执行
...
<script>
  ...
  export default {
    ...
    beforeMount(){
      ...
      if(this.formObj.stepFormInfo.caseStepDef.stepActOwner){
        this.memberRefList = JSON.parse(this.formObj.stepFormInfo.caseStepDef.stepActOwner);
      }
    },
    computed:{
      caseStepDef(){
