<template>
    <el-form ref="taskDefForm" class="task-def-form" :model="detailForm" :disabled="mode==='view'"
        ...
        <el-form-item v-if="detailForm.taskType === '6'" label="回填参数">
                <div class="rule-table">
                    <el-table header-row-class-name="rule-header-row"
                              header-cell-class-name="rule-header-cell"
                              row-class-name="rule-row"
        ...
        <el-form-item v-if="detailForm.taskType === '4'" label="机器人选择" prop="stepActKey">
            <el-select style="width: 100%" v-model="detailForm.stepActKey" placeholder="请选择" filterable clearable>
                <gf-filter-option
        ...
        <el-form-item label="执行频率配置" v-if="detailForm.taskType === '1' || detailForm.taskType === '4'" prop="execScheduler">
            <el-button type="text" @click="editExecTime(detailForm.step_execScheduler,'执行频率配置')">
