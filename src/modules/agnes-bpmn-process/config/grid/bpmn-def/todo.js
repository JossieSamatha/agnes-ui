...
export default {
    columnDefs: [
        ...
        {headerName: "处理意见", field: "showUserName"},
        {
            headerName: "开始时间", field: "applyTime", cellRenderer: (params) => {
                if (!params.value) {
                    return ''
                } else {
                    let formatDate = '';
        ...
        {
            headerName: "结束时间", field: "receiveTime", cellRenderer: (params) => {
                if (!params.value) {
                    return ''
                } else {
                    let formatDate = '';
        ...
        {headerName: "耗时", field: "showUserName"},
