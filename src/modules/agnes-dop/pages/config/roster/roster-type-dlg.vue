        ...
        <el-form class="fit-box" :disabled="mode==='view' ||mode==='approve' " :model="form" ref="form" :rules="rules"
            ...
            <el-form-item label="值班类型" prop="rosterType">
                <el-select v-model="form.rosterType" clearable>
                    <el-option v-for="item in rosterTypeDict" :key="item.dictId" :label="item.dictName"
                               :value="item.dictId">
                    </el-option>
                </el-select>
            </el-form-item>
    ...
    export default {
        data() {
            return {
                ...
                pickerOptionsStart: {
                    disabledDate: time => {
                        let endDateVal = this.form.rosterEndDate;
                        if (endDateVal) {
                ...
                pickerOptionsEnd: {
                    disabledDate: time => {
                        let beginDateVal = this.form.rosterStartDate;
                        if (beginDateVal) {
