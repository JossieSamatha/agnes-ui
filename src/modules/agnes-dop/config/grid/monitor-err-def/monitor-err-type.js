...
export default {
    columnDefs: [
        ...
        {headerName: "处理状态", field: "status", formatType: 'dict',dictType: 'AGNES_RELEASE_STATUS'},
        {headerName: "处理时间", field: "updateTs"},
        {headerName: "异常类型", field: "errType", formatType: 'dict',dictType: 'AGNES_DOP_ERR_TYPE'},
        {headerName: "异常描述", field: "errDesc"},
        {headerName: "是否调入风险", field: "isRisk", formatType: 'dict',dictType: 'OPDS_YES_NO'},
