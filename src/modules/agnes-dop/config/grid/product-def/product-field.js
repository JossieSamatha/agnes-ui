...
export default {
    columnDefs: [
        ...
        {headerName: "管理费率", field: "managementRate"},
        {headerName: "托管费率", field: "trustRate"},
        {headerName: "浮动管理费", field: "floatingManagementFee"},
        {headerName: "浮动管理费描述", field: "floatingManagementFeeDesc"},
        {headerName: "其他费率描述", field: "otherRateDesc"},
        {headerName: "业绩比较基准", field: "performanceBaseline"},
        {headerName: "清算日期", field: "settlementDate"},
        {headerName: "关账日期", field: "closeDate"},
        {headerName: "到期日期", field: "dueDate"},
